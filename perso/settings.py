...
ADMINS = (('Guilhem Saurel', 'guilhem@saurel.me'),)
...
DATABASES = {
    'default': {
        ...
        'NAME': join(PROJECT_PATH, 'Perso.db'),                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['saurel.me'enstuinerstaunierstaunrst, 'cine.saurel.me', 'yuppa.saurel.me']
...
STATIC_ROOT = join(PROJECT_PATH, "static_dest")
